...
job_json = {
    ...
    "tags": {"usage": "solacc_testing", "group": "SOLACC"},
    "tasks": [
        {
            "job_cluster_key": "sample_solacc_cluster",
            "notebook_task": {"notebook_path": "00_Intro_and_Config"},
            "task_key": "00",
        },
        {
            "job_cluster_key": "sample_solacc_cluster",
            "notebook_task": {"notebook_path": "01_Data_Prep"},
            "task_key": "01",
            "depends_on": [{"task_key": "00"}],
        },
        {
            "job_cluster_key": "sample_solacc_cluster",
            "notebook_task": {"notebook_path": "02_Extract_Image_Descriptions"},
            "task_key": "02",
            "depends_on": [{"task_key": "01"}],
        },
        {
            "job_cluster_key": "sample_solacc_cluster",
            "notebook_task": {"notebook_path": "03_Generate_Product_Descriptions"},
            "task_key": "03",
            "depends_on": [{"task_key": "02"}],
        },
    ],
    "job_clusters": [
        {
            ...
            "new_cluster": {
                ...
                "spark_conf": {"spark.databricks.delta.formatCheck.enabled": "false"},
                "num_workers": 2,
                "node_type_id": {
                    "AWS": "g5.16xlarge",
                    "MSA": "Standard_NC48ads_A100_v4",
                },
                "custom_tags": {"usage": "solacc_testing"},
            },
        }
    ],
}
...
spark.sql(
    "CREATE DATABASE IF NOT EXISTS databricks_solacc LOCATION '/databricks_solacc/'"
)
spark.sql(
    "CREATE TABLE IF NOT EXISTS databricks_solacc.dbsql (path STRING, id STRING, solacc STRING)"
)
...
_ = nsc.deploy_dbsql(
    "./dashboards/IoT Streaming SA Anomaly Detection.dbdash", dbsql_config_table, spark
)
