...
kafka_bootstrap_servers = dbutils.secrets.get(
    "solution-accelerator-cicd", "iot-anomaly-kafka-bootstrap-server"
)
security_protocol = "SASL_SSL"
sasl_mechanism = "PLAIN"
sasl_username = dbutils.secrets.get(
    "solution-accelerator-cicd", "iot-anomaly-sasl-username"
)
sasl_password = dbutils.secrets.get(
    "solution-accelerator-cicd", "iot-anomaly-sasl-password"
)
topic = "iot_msg_topic"
